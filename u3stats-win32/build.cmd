@echo off
rem Builds "Ultima III Assistant.exe" with MinGW-w64 (MSYS2). No other dependencies.
setlocal
cd /d "%~dp0"
...
g++ -std=c++17 -O2 -s -static -municode -mwindows ^
    ...
    "-Wl,-Map,Ultima III Assistant.map" -o "Ultima III Assistant.exe" || exit /b 1
del app.res.o
echo Built "%~dp0Ultima III Assistant.exe"
